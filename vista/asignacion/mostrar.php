	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  <li class="active">Listado de asignaciones</li>
				  <li><a href="asignacion.php?op=nuevo">Nueva asignación</a></li>
				</ol>
			</div>
		</div>
	</div>
...
?>
	...
	<div class="container-fluid">
            <h2 class="text-center all-tittles">listado de asignaciones</h2>
		  ...
		  <input id="FiltrarContenido" type="text" class="form-control" placeholder="Buscar asignación" aria-label="Grado" aria-describedby="basic-addon1">
		</div>
