...
<?php
            ...
            <div class="nav-lateral-divider full-reset"></div>
             <div class="full-reset nav-lateral-list-menu">
                <ul class="list-unstyled">
                    ...
                    <li><a href="grado.php"><i class="zmdi zmdi-face zmdi-hc-fw"></i>&nbsp;&nbsp; Académico</a></li>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
		...
		<div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
              ...
              <li role="presentation"><a href="tema.php">Tema</a></li>
              <li role="presentation"><a href="clase.php">Clase</a></li>
              <li role="presentation"><a href="seccion.php">Secciones</a></li>
			   <li role="presentation"><a href="plan.php">Plan </a></li>
			    <li role="presentation" class="active"><a href="#">Asignación</a></li>
		 ...
		 <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para registrar una nueva tarea, debes de llenar todos los campos del siguiente formulario para poder registrarlo.
                </div>
            </div>
        </div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  <li><a href="asignacion.php">Listado de asignaciones</a></li>
	...
	<div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Agregar asignaciones</div>
				
				
                <form class="form-padding" method="post" action="?op=recibir" autocomplete="off">
                    <div class="row">
                        <div class="col-xs-12">
                            <legend><i class="zmdi zmdi-flower"></i> &nbsp; Datos de la asignación</legend><br>
                        </div>
						
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
					<input type="text" class="material-control tooltips-general" name="txttituloa" placeholder="Nombre de la tarea" required=""  data-toggle="tooltip" data-placement="top" title="Escribe el nombre de la tarea">
			...
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
					<input type="date"  class="material-control tooltips-general" name="txtfechali" placeholder="Fecha" required=""  data-toggle="tooltip" data-placement="top" title="Escribe la fecha">
					<span class="highlight"></span>
					<span class="bar"></span>
					<label>Fecha de límite</label>
				</div>
			</div>
			...
			<div class="group-material">
				<span>Docente</span>
				<select class="material-control" name="cbodoce" id="doce" tooltips-general" data-toggle="tooltip" data-placement="top" title="Elige el docente">
					<option value=""  selected="">Selecciona el docente</option>
			...
			<div class="group-material">
				<span>Clase</span>
				<select class="material-control" name="cbocla" id="class" tooltips-general" data-toggle="tooltip" data-placement="top" title="Elige el grado">
					<option value=""  selected="">Selecciona la clase</option>
			...
			<div class="group-material">
				<span>Sección</span>
				<select class="material-control" name="cbosec" id="seccion" tooltips-general" data-toggle="tooltip" data-placement="top" title="Elige el grado">
					<option value=""  selected="">Selecciona la sección</option>
