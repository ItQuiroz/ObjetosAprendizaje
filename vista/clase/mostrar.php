    ...
    <div class="content-page-container full-reset custom-scroll-containers">
		...
		<div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
              <li role="presentation"><a href="grado.php">DRESCRIPCION</a></li>
              <li role="presentation"><a href="tema.php">PLANTEAMIENTO</a></li>
              <li role="presentation" class="active"><a href="#">DIAGRAMA DE FLUJO</a></li>
		 ...
		 <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
				...
				<div class="col-xs-12 col-sm-4 col-md-7">
                    <img src="../assets/images/flujo.png" alt="user" class="" style="max-width: 1100px;">
                </div>
            </div>
        </div>
